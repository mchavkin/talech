...
const fields = ['name', 'ean', 'type', 'weight', 'active', 'quantity', 'price'];
...
export default function NewProduct() {
    ...
    const [inputs, setInputs] = useState({...fields.reduce((a, c) => ({...a, [c]: ''}), {}), active: true});
    ...
    return (
        <div className={classes.container}>
            <form className={classes.root} autoComplete="off" noValidate onSubmit={handleSubmit(onSubmit)}>
                <TextField
                    name={'name'}
                    value={inputs['name']}
                    label={t(`field.${'name'}`)}
                ...
                >
                    {colors.map(colorOption => (
                            <MenuItem key={colorOption} value={colorOption}>
                                <Checkbox checked={color.includes(colorOption)} color='primary'/>
                                <ListItemIcon>
                ...
                <div className={classes.buttons}>
                    ...
                    <Button variant="outlined" color="primary"
                            onClick={() => history.push('/')}>{t('buttons.cancel')}</Button>
                </div>
            </form>
        </div>
    )
